...
success:function(data)
{
  ...
  ?>
          ...
          <h1 class="page-header">Students List <button style="float:right" type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">
      <i class="glyphicon glyphicon-plus"></i> New Student</button></h1>
...
<div class="form-group">
  <label class="col-xs-4 control-label" for="lrn">LRN NO.</label>  
  <div class="col-xs-6">
...
<div class="form-group">
  ...
  <table id="students" class="table table-bordered table-condensed">
    <thead>
      <tr id="heads">
        <th style="width:10%;text-align:center">Student No.</th>
